...
> A guide about bookmarks in which no bookmark could be created by the
...
**Bookmarks are not broken** — see `docs/evidence-notes/search-jobs.md`. Reached via Azure Logs from Sentinel's
