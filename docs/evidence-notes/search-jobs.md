---
title: Search jobs — a page that runs no search job, and the bookmark that closed the hunting-bookmarks note
date: 2026-08-15
artifacts:
  labs: ["26"]
  posture: []
...
then functional. This is what narrows the defect recorded in `docs/evidence-notes/hunting-bookmarks.md` from "bookmarks
