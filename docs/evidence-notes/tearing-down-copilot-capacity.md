...
# Tearing down the capacity

> The source guide that closes the meter, and the last of the Sentinel-automation section. Its stated
...
guide tears down by typing a group name into a confirm dialog. The Create form
...
capacity landed in a shared group, following this guide
...
Deletion inside the provisioning clock hour: **one unit**. The Sentinel-automation section closes
here — the teardown guide is its last.
