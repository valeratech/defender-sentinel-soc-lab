---
module: 109
title: Archived log data — a module whose subject does not exist in this tenant
...
> is zero, so the module's subject does not exist.
...
posture entries this module produced.

## What could not be tested

Everything the module is nominally about. Search over long-term retention and
