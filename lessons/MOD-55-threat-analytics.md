...
**A working hypothesis was withdrawn mid-module.** Threat analytics was expected
...
with custom detections (module 56) and analytics rules (module 59). Predict
