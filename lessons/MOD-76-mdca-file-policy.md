...
# Module 76 — The Console That Was Already Configured
...
Everything else in the module was read-only.
...
This module also occasioned two `*(pending)*` markers being added to `Lab 15`,
