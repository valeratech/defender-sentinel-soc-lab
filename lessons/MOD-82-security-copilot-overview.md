...
# Module 82 — What is Microsoft Security Copilot

> The vocabulary module. It produces no tenant state, but every term the
> remaining modules spend — SCU, provisioned capacity, inclusion, agent,
...
Nothing. The module is descriptive throughout.
...
connects the module to the rest of the repo: every scoped-access finding already
...
The answer changes later modules rather than this one. If a Default capacity
