...
# Module 83 — Security compute units and capacity

> The billing-mechanics module, and the one that sets the shape of the paid
...
promptbooks and agents draw from the same provisioned capacity (module 82).
...
**The Purview example has expired.** The module illustrates the
...
**Inclusion skips provisioning, not the resource.** The module states that
...
management. The distinction is load-bearing for modules 85 and 88.
...
control at all depends on the unresolved inclusion question (module 82).

**The module's overage guidance is inverted for this environment, and the
