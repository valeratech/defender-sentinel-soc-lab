...
# Module 84 — Before allocating SCUs

> The last module before money. Its content is one sentence with consequences:
...
roughly **$96/day**, consistent with the ~$2,900/month figure in module 82.
...
**The module's cost escape hatch does not exist in this subscription.** It
...
So the module's two paths collapse to one: the provision-work-delete cycle on a
paid subscription. Recorded because this is the first instance of a previously
committed finding **pre-refuting a later module's advice** rather than being
corrected by one.

## What could not be tested

**The sequence in §1 is scoped to standalone deployments, and whether this
tenant is one is unresolved.** Module 82 records the open inclusion question;
...
none of modules 82–84 requires a withdrawal — they were written conditionally
because the condition is genuinely open.

**Operational sharpening, recorded before the paid hour.** The module advises
deleting the capacity resource in the same hour it was created. Against the
hourly-block rule (module 83) the real target is: finish inside one clock hour,
or buy the second knowingly at $4. Given three modules to execute and a
...
This closes the unpaid run. Modules 85–88 open the meter.
