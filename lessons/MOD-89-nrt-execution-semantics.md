...
# Module 89 — Anomaly rules and NRT execution semantics
...
absence is configuration, not fault. Extends MOD-57's store-partition finding.
...
`Anomalies` table holds 0 rows (MOD-61, `POS-044`), so there is nothing to
